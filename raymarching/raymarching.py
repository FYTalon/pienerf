...
try:
    # print("raymarching: trying...")
    import _raymarching as _backend
    # print("raymarching: _raymarching imported")
except ImportError:
...
class _march_rays(Function):
    ...
    def forward(ctx,
                ...
                bound, density_bitfield, C, H, near, far,
        ...
        _backend.march_rays(
            n_alive, n_step, rays_alive,
            rays_t, rays_o, rays_d,
            bound, dt_gamma, max_steps,
            C, H, density_bitfield, near, far,
...
class _march_rays_quadratic_bending(Function):
    @staticmethod
    @custom_fwd(cast_inputs=torch.float32)
    def forward(ctx,
...
march_rays_quadratic_bending = _march_rays_quadratic_bending.apply
